...
{
    [KernelFunction]
    [Description("Get Bookings WithMultiple HotelRooms")]
...
[KernelFunction]
    [Description("Get Bookings for MissingHotelRooms")]
    ...
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate([Description("The ID of the hotel")] int hotelId,[Description("The Date and time of bookin")] DateTime dt)
    {
